const Map<String, dynamic> tweakTestVecotr = {
  ...
  "valid_test_cases": [
    ...
    },
    {
      ...
      "comment":
          "Four tweaks: x-only, plain, x-only, plain. If an implementation prohibits applying plain tweaks after x-only tweaks, it can skip this test vector or return an error.",
    },
  ],
  "error_test_cases": [
    {
