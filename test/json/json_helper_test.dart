...
void main() {
  group("JsonHelper", () {
    test("bigint", () {
      ...
      expect(
        testVector.valueAsBigInt("bStringHex", allowHex: true),
    ...
    test("bytes", () {
      ...
      expect(
        testVector.valueAsBytes("bytesAsString", encoding: StringEncoding.utf8),
    ...
    test("map", () {
      ...
      expect(
        testVector.valueAsMap<Map<int, dynamic>>("mapInt").valueAsInt(1),
        1,
      );
      expect(
    ...
    test("value as", () {
      ...
      expect(
        testVector.valueTo<BigInt, Object>(
          key: "bString",
          parse: (v) => BigInt.parse(v.toString()),
        ),
        BigInt.one,
      );
      expect(
