...
class CardanoByronLegacyBip32 extends Bip32Base<CardanoByronLegacyBip32> {
  ...
  CardanoByronLegacyBip32.fromPublicKey(
    super.pubkey, [
    super.keyData,
    super.keyNetVer,
  ]) : super.fromPublicKey();
  ...
  @override
  CardanoByronLegacyKeyDerivator get keyDerivator {
