...
class CardanoIcarusBip32 extends Bip32Base<CardanoIcarusBip32> {
  ...
  CardanoIcarusBip32.fromPrivateKey(
    List<int> privKey, {
  ...
  CardanoIcarusBip32.fromPublicKey(
    List<int> pubkey, {
    Bip32KeyData? keyData,
    Bip32KeyNetVersions? keyNetVer,
  ...
  @override
  Bip32KholawEd25519KeyDerivator get keyDerivator {
