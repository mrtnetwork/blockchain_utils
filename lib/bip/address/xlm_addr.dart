...
class XlmAddrDecoder implements BlockchainAddressDecoder {
  ...
  List<int> decodeAddr(String addr, [Map<String, dynamic> kwargs = const {}]) {
    ...
    ///
    /// Throws an [ArgumentError] if the address type is not valid or if there's a validation error.
    ///
    /// Example usage:
    /// ```dart
    ...
    if (addrType is! XlmAddrTypes) {
      throw ArgumentError('Address type is not an enumerative of XlmAddrTypes');
    }
