...
class G1Projective extends Bls12Point<G1Projective> {
  ...
  final Bls12Fp y;
  final Bls12Fp z;
  G1Projective({required this.x, required this.y, required this.z});
...
class G1AffinePoint extends Bls12AffinePoint<G1Projective> with Equality {
  ...
  final Bls12Fp y;
  final bool infinity;
  G1AffinePoint({required this.x, required this.y, required this.infinity});
  ...
  static final _identity = G1AffinePoint(
    x: Bls12Fp.zero(),
    y: Bls12Fp.one(),
    infinity: true,
  );
  factory G1AffinePoint.identity() => _identity;
